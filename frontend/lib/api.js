...
export const api = {
  ...
  internal: {
    ...
    social: {
      summary: () => request('/api/internal/operations/social'),
      queue: () => request('/api/internal/operations/social/queue'),
      ...
      settings: () => request('/api/internal/operations/social/settings'),
      updateSettings: (body) => request('/api/internal/operations/social/settings', { method: 'PATCH', body }),
      pause: () => request('/api/internal/operations/social/pause', { method: 'POST' }),
      resume: () => request('/api/internal/operations/social/resume', { method: 'POST' }),
      discover: () => request('/api/internal/operations/social/discover', { method: 'POST', timeoutMs: 30000 }),
      process: () => request('/api/internal/operations/social/process', { method: 'POST', timeoutMs: 60000 }),
      editCaption: (postId, caption) => request(`/api/internal/operations/social/posts/${encodeURIComponent(postId)}/caption`, { method: 'PATCH', body: { caption } }),
      regenerateCaption: (postId) => request(`/api/internal/operations/social/posts/${encodeURIComponent(postId)}/caption/regenerate`, { method: 'POST', timeoutMs: 30000 }),
      ...
      decideEngagement: (engagementId, decision) => request(`/api/internal/operations/social/engagement/${encodeURIComponent(engagementId)}/${decision}`, { method: 'POST' }),
    },
