...
from backtesting.player_prop_odds import evaluate_persisted_quotes, validate_player_prop_rows
...
def test_validation_timestamp_and_zero_line():
    ...
    errors=validate_player_prop_rows([{**base,"market_last_update":"2025-09-04T00:16:00Z"}],[GAME],players)
    assert any("market_update_after_provider_snapshot" in e for e in errors)
