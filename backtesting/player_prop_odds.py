...
from .team_history import filter_market_quotes
...
def normalize_provider_outcomes(event: dict[str, Any], *, league: str, season: int, week: int,
                                ...
                                snapshot_timestamp: str, source: str = "the-odds-api-historical") -> tuple[list[dict[str, Any]], list[dict[str, Any]]]:
        ...
        for raw_market in book.get("markets", []) or []:
            ...
            for outcome in raw_market.get("outcomes", []) or []:
                ...
                rows.append(PlayerPropQuote(
                    ...
                    float(outcome["point"]), american, decimal, 1 / decimal, str(book.get("key") or book.get("title")),
